...
alias BT0='~/SWMF/util/AMREX/Tools/Backtrace/parse_bt.py ~/SWMF/run/SWMF.exe ~/SWMF/run_test/Backtrace.0>~/SWMF/run_test/Backtracetmp;rm -rf ~/SWMF/run_test/Backtrace.0;mv ~/SWMF/run_test/Backtracetmp ~/SWMF/run_test/Backtrace.0;code ~/SWMF/run_test/Backtrace.0'
