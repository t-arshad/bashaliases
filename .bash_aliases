...
alias alldebug='cd ~/SWMF;./Config.pl -debug -O0;make clean;make distclean -C ~/SWMF/util/AMREX/;cd ~/SWMF/util/AMREX/;./configure;make clean -C ~/SWMF/PC/FLEKS/'
alias allnodebug='cd ~/SWMF;./Config.pl -nodebug -O4;make clean;make distclean -C ~/SWMF/util/AMREX/;cd ~/SWMF/util/AMREX/;./configure;make clean -C ~/SWMF/PC/FLEKS/'
