...
alias aliasesemacs='git -C ~/bashaliases pull;emacs ~/.bash_aliases -yes;git -C ~/bashaliases commit -a -m "Updated .bash_aliases";git -C ~/bashaliases push;. ~/.bash_aliases'
